...
function Footer() {
  ...
  return <Box bgcolor= "#fbf2f2" display="flex" flexDirection="column">
    ...
    <Typography fontSize={{lg:24, md:20, sm:16, xs:12}} variant="div" padding={4} textAlign="center">A fine-tuned pretrained MaxViT model for cell painting assay classification</Typography>
